...
<div class="space-y-1">
    {{-- Dashboard --}}
    <x-navigation.sidebar-menu-item href="{{ route('user.dashboard') }}" :active="$currentRoute === 'user.dashboard'"
    ...
    {{-- Trucks Dropdown --}}
    <x-navigation.sidebar-menu-dropdown label="Trucks" :active="$isTrucksActive"
    ...
    {{-- Reports --}}
    <x-navigation.sidebar-menu-item href="{{ route('user.reports') }}" :active="$currentRoute === 'user.reports'"
        icon='<svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
