            ...
            <a href="{{ route('location.login', $location->id) }}"
                ...
                <div class="hidden sm:block p-5 sm:p-6">
                    ...
                    <div class="flex justify-center items-center mb-4 sm:mb-5 h-20 sm:h-24">
                        ...
                        @else
                            <div class="flex items-center justify-center h-full w-full bg-linear-to-br from-orange-50 to-orange-100 rounded-xl px-4">
                                <span class="text-lg sm:text-xl lg:text-2xl font-bold text-orange-700 text-center leading-tight">
                    ...
                    <div class="text-center mb-3 sm:mb-4">
                        <h3 class="text-base sm:text-lg font-semibold text-gray-800 line-clamp-2 wrap-break-words whitespace-normal">
                            {{ $location->location_name }}
                        </h3>
                    </div>
                    ...
                    <!-- Stats Section -->
                    <div class="flex items-center justify-between bg-linear-to-r from-red-50 to-orange-50 rounded-xl p-3 sm:p-4">
                        ...
                        <div class="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full shadow-md group-hover:bg-orange-500 transition-colors">
                ...
                <div class="sm:hidden p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="shrink-0 w-14 h-14">
                            ...
                            @else
                                <div class="flex items-center justify-center w-full h-full bg-linear-to-br from-orange-50 to-orange-100 rounded-lg">
                                    <span class="text-xs font-bold text-orange-700 text-center leading-tight px-1">
                                        {{ substr($location->location_name, 0, 3) }}
                                    </span>
                                </div>
                            @endif
                        </div>
                        ...
                        <div class="flex items-center gap-2 shrink-0">
                            ...
                            <div class="flex items-center justify-center w-8 h-8 bg-orange-500 rounded-full shadow-md group-hover:bg-orange-600 transition-colors">
                ...
                <!-- Bottom accent bar -->
                <div class="absolute bottom-0 left-0 right-0 h-1 bg-linear-to-r from-orange-400 to-red-500 transform scale-x-0 group-hover:scale-x-100 transition-transform origin-left"></div>

                <!-- Hover glow effect -->
                <div class="absolute inset-0 bg-linear-to-br from-orange-400/0 to-red-400/0 group-hover:from-orange-400/5 group-hover:to-red-400/5 transition-all duration-300 pointer-events-none rounded-2xl"></div>
            </a>
        @empty
            <div class="col-span-full">
                <div class="bg-white rounded-2xl shadow-md border border-gray-200 p-8 sm:p-12 text-center">
                    <svg class="w-16 h-16 sm:w-20 sm:h-20 mx-auto mb-4 text-gray-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
