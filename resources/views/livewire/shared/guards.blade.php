            ...
            <x-modals.filter-modal>
                <x-slot name="filters">
                    @if ($config['showGuardTypeFilter'])
                        <x-modals.filter-guards-body :availableStatuses="$availableStatuses" :availableGuardTypes="$availableGuardTypes" :showGuardTypeFilter="true" />
                    @else
                        <x-modals.filter-guards-body :availableStatuses="$availableStatuses" :availableGuardTypes="[]" :showGuardTypeFilter="false" />
                    @endif
                </x-slot>
            </x-modals.filter-modal>
        @endif
