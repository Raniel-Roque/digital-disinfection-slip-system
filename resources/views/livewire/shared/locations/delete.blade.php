                ...
                <div
                    ...
                    <div class="px-6 py-4 bg-white border-b border-gray-200">
                        <div class="flex items-center">
                            ...
                            <h3 class="ml-4 text-lg font-semibold text-gray-900">Delete Location</h3>
                        </div>
                    </div>
                    ...
                    <div class="px-6 py-4">
                        ...
                        <p class="text-sm text-gray-600">
                            Are you sure you want to delete <span
                                class="font-semibold text-gray-900">{{ $locationName }}</span>? This action cannot be
                            undone. The location will be permanently removed from the system.
                        </p>
                    </div>
