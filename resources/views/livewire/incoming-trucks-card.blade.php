<a href="{{ route('user.incoming-trucks') }}" class="flex-1 flex flex-wrap items-center border border-orange-300 rounded-lg p-6 shadow-sm hover:shadow-md transition" wire:poll="updateCount">
    ...
    <span class="text-red-600 font-bold text-2xl ml-auto min-w-[50px] mt-2 md:mt-0">{{ str_pad($count, 4, '0', STR_PAD_LEFT) }}</span>
</a>
