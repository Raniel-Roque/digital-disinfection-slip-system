<div class="min-h-screen bg-gray-50 p-6" @if (!$showFilters) wire:poll.keep-alive @endif>
    <div class="max-w-7xl mx-auto">
        ...
        {{-- Edit Modal --}}
        <livewire:shared.vehicles.edit :config="['minUserType' => 1]" />

        {{-- Disable/Enable Confirmation Modal --}}
        <livewire:shared.vehicles.disable :config="['minUserType' => 1]" />

        {{-- Create Vehicle Modal --}}
        <livewire:shared.vehicles.create :config="['minUserType' => 1]" />
    </div>
</div>
