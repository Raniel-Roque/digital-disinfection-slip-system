...
class Edit extends Component
{
    ...
    // Watch for changes to prevent same selection
    ...
    {
        // Reload slip data to restore original state
        $this->loadSlipData();
        $this->resetForm();
    ...
    // Paginated data fetching methods (same as Create component)
    #[Renderless]
